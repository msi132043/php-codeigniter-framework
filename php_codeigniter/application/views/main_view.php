...
<body>
	<div class="container">
		<h3 align='center'>Insert Delete and Update Data using CodeIgniter</h3><br />
		<form method="post" action="<?php echo base_url()?>main/form_validation">
            <?php
            if($this->uri->segment(2) == "inserted"){
                echo '<p class="text-success">Data Inserted</p>';
                //base url - http://localhost/php_codeigniter/ 
                //redirect url - http://localhost/php_codeigniter/main/inserted  
                //main - segment(1)  
                //inserted - segment(2)
            }
        ...
        <h3 align="center">Fetch Data from Table using Codenigter</h3><br />
